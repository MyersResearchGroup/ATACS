...
loc ld0r1: while Il>=4500 & Il<=40400 & Vc<=0 wait {dVc=0, dIl=24}
  when Il=4500 goto ld0r0;
  when Il=40400 goto ld0r2;
  when Vc>=0 goto l1;

loc ld0r2: while Il>=38200 & Il<=105500 & Vc<=0 wait {dVc=489, dIl=12}
  when Il=38200 goto ld0r1;
  when Il=105500 goto ld0r3;
  when Vc>=0 goto l2;

loc ld0r3: while Il>=103300 & Vc<=0 wait {dVc=848, dIl=3}
...
loc l1: while Il>=4500 & Il<=40400 & Vc>=0 & Vc<=20400 wait {dVc=-5, dIl=24}
  when Il=4500 goto l0;
  when Il=40400 goto l2;
  when Vc=0 goto ld0r1;
  when Vc=20400 goto l5;

loc l2: while Il>=38200 & Il<=105500 & Vc>=0 & Vc<=20400 wait {dVc=489, dIl=12}
  when Il=38200 goto l1;
  when Il=105500 goto l3;
  when Vc=0 goto ld0r2;
  when Vc=20400 goto l6;

loc l3: while Il>=103300 & Vc>=0 & Vc<=20400 wait {dVc=848, dIl=3}
...
loc l5: while Il>=4500 & Il<=40400 & Vc>=10200 & Vc<=173500 wait {dVc=-673, dIl=15}
  when Il=4500 goto l4;
  when Il=40400 goto l6;
  when Vc=10200 goto l1;
  when Vc=173500 goto l9;

loc l6: while Il>=38200 & Il<=105500 & Vc>=10200 & Vc<=173500 wait {dVc=-179, dIl=3}
  when Il=38200 goto l5;
  when Il=105500 goto l7;
  when Vc=10200 goto l2;
  when Vc=173500 goto l10;

loc l7: while Il>=103300 & Vc>=10200 & Vc<=173500 wait {dVc=180, dIl=-5}
...
loc l9: while Il>=4500 & Il<=40400 & Vc>=163300 & Vc<=489800 wait {dVc=-85, dIl=-8}
  when Il=4500 goto l8;
  when Il=40400 goto l10;
  when Vc=163300 goto l5;
  when Vc=489800 goto l13;

loc l10: while Il>=38200 & Il<=105500 & Vc>=163300 & Vc<=489800 wait {dVc=409, dIl=-20}
  when Il=38200 goto l9;
  when Il=105500 goto l11;
  when Vc=163300 goto l6;
  when Vc=489800 goto l14;

loc l11: while Il>=103300 & Vc>=163300 & Vc<=489800 wait {dVc=768, dIl=-29}
...
loc l13: while Il>=4500 & Il<=40400 & Vc>=479600 wait {dVc=-690, dIl=-25}
  when Il=4500 goto l12;
  when Il=40400 goto l14;
  when Vc=479600 goto l9;

loc l14: while Il>=38200 & Il<=105500 & Vc>=479600 wait {dVc=-197, dIl=-37}
  when Il=38200 goto l13;
  when Il=105500 goto l15;
  when Vc=479600 goto l10;

loc l15: while Il>=103300 & Vc>=479600 wait {dVc=163, dIl=-46}
