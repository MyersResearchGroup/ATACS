...
-- 1735 4796 10550 11000 8 -3
-- 4898 5000 0 450 -9 -2
-- 4898 5000 670 3820 -7 -3
-- 4898 5000 4040 10330 -2 -4
-- 4898 5000 10550 11000 2 -5
...
loc ld0r1: while Il>=450 & Il<=4040 & Vc<=0 wait {dVc=0, dIl=2}
  when Il=450 goto ld0r0;
  when Il=4040 goto ld0r2;
  when Vc>=0 goto l1;

loc ld0r2: while Il>=3820 & Il<=10550 & Vc<=0 wait {dVc=5, dIl=1}
...
loc l1: while Il>=450 & Il<=4040 & Vc>=0 & Vc<=204 wait {dVc=-1, dIl=2}
  when Il=450 goto l0;
  when Il=4040 goto l2;
  when Vc=0 goto ld0r1;
  when Vc=204 goto l5;

loc l2: while Il>=3820 & Il<=10550 & Vc>=0 & Vc<=204 wait {dVc=5, dIl=1}
...
loc l11: while Il>=10330 & Vc>=1633 & Vc<=4898 wait {dVc=8, dIl=-3}
...
loc l13: while Il>=450 & Il<=4040 & Vc>=4796 wait {dVc=-7, dIl=-3}
  when Il=450 goto l12;
  when Il=4040 goto l14;
  when Vc=4796 goto l9;

loc l14: while Il>=3820 & Il<=10550 & Vc>=4796 wait {dVc=-2, dIl=-4}
  when Il=3820 goto l13;
  when Il=10550 goto l15;
  when Vc=4796 goto l10;

loc l15: while Il>=10330 & Vc>=4796 wait {dVc=2, dIl=-5}
