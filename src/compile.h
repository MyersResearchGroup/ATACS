...
/*****************************************************************************/
/* Create and store an ER system from temporary files (<filename>.inp,       */
/*   <filename>.out, <filename>.rule, <filename>.ord, and <filename>.merg).  */
/*****************************************************************************/
...
/*****************************************************************************/
/* Compile CSP into an ER system.                                            */
/*****************************************************************************/

bool compile(char command,designADT design,bool newfile);

void initialize_parser(const string&, bool);
void free_parser(FILE*);
