...
import edu.utah.ece.async.ibiosim.gui.atacsGui;
...
public class SynthesisViewATACS extends JPanel implements ActionListener, Runnable {
	 ...
	 * displays the frame.
	 */
	public SynthesisViewATACS(String directory, String filename, Log log, atacsGui biosim) {
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(atacsGui.frame, "Unable to load properties file!",
		...
		if (sourceFile.endsWith(".s") || sourceFile.endsWith(".inst")) {
			...
			try {
				...
				JOptionPane.showMessageDialog(atacsGui.frame,
	...
	public void run() {
		...
		for (String s : componentList.getItems()) {
			try {
				...
				e1.printStackTrace();
				JOptionPane.showMessageDialog(atacsGui.frame, "Cannot update the file " + s + ".",
		...
		try {
			...
			if (exitValue == 143) {
				JOptionPane
						.showMessageDialog(atacsGui.frame, "Synthesis was"
	...
	public void saveAs() {
		String newName = JOptionPane.showInputDialog(atacsGui.frame, "Enter Synthesis name:",
	...
	public void save() {
		try {
			...
			JOptionPane.showMessageDialog(atacsGui.frame, "Unable to save parameter file!",
		...
		for (String s : componentList.getItems()) {
			try {
				...
				e1.printStackTrace();
				JOptionPane.showMessageDialog(atacsGui.frame, "Cannot add the selected component.",
						"Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
		...
		try {
			...
			if (!circuit.exists()) {
				...
				if (new File(directory + separator + graphFile).exists()) {
					...
					JOptionPane.showMessageDialog(atacsGui.frame, scrolls, "Log",
			...
			JOptionPane.showMessageDialog(atacsGui.frame, "Unable to view circuit.", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void viewRules() {
		...
		try {
			if (new File(circuitFile).exists()) {
				...
				scrolls.setPreferredSize(new Dimension(500, 500));
				scrolls.setViewportView(messageArea);
				JOptionPane.showMessageDialog(atacsGui.frame, scrolls, "Circuit View",
						JOptionPane.INFORMATION_MESSAGE);
			}
			else {
				JOptionPane.showMessageDialog(atacsGui.frame, "No production rules exist.",
						"Error", JOptionPane.ERROR_MESSAGE);
			}
		}
		catch (Exception e1) {
			JOptionPane.showMessageDialog(atacsGui.frame, "Unable to view production rules.",
					"Error", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void viewTrace() {
		...
		try {
			if (new File(traceFilename).exists()) {
				...
				scrolls.setPreferredSize(new Dimension(500, 500));
				scrolls.setViewportView(messageArea);
				JOptionPane.showMessageDialog(atacsGui.frame, scrolls, "Trace View",
						JOptionPane.INFORMATION_MESSAGE);
			}
			else {
				JOptionPane.showMessageDialog(atacsGui.frame, "No trace file exists.", "Error",
						JOptionPane.ERROR_MESSAGE);
			}
		}
		catch (Exception e1) {
			JOptionPane.showMessageDialog(atacsGui.frame, "Unable to view trace.", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void viewLog() {
		try {
			if (new File(directory + separator + "run.log").exists()) {
				...
				scrolls.setPreferredSize(new Dimension(500, 500));
				scrolls.setViewportView(messageArea);
				JOptionPane.showMessageDialog(atacsGui.frame, scrolls, "Run Log",
						JOptionPane.INFORMATION_MESSAGE);
			}
			else {
				JOptionPane.showMessageDialog(atacsGui.frame, "No run log exists.", "Error",
						JOptionPane.ERROR_MESSAGE);
			}
		}
		catch (Exception e1) {
			JOptionPane.showMessageDialog(atacsGui.frame, "Unable to view run log.", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
